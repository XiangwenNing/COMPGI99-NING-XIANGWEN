...
#        old_variables_list = [v for v in self.model_module.variables if 'fully' not in v.name and 'coattention' not in v.name and 'encoder' not in v.name and  'ones' not in v.name and 'att' not in v.name and 'aggregation' not in v.name and 'bias' not in v.name and 'slot' not in v.name and 'match' not in v.name and 'kernel' not in v.name]
